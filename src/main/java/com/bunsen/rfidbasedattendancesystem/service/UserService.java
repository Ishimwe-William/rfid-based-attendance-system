...
public class UserService {
    ...
    public UserService(UserRepository userRepository, RoleRepository roleRepository, PasswordEncoder passwordEncoder, CardRepository cardRepository, EmailService emailService) {
    ...
    public User findByCardNumber(String cardNo) {
        return userRepository.findByCard(cardNo);
    }
}
